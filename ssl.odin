...
create_ctx :: proc(certPath: cstring, pkeyPath: cstring, certType: Certificate, pkeyType: Certificate) -> SSL_Context {
...
read_to_string :: proc(conn: SSL_Connection, $bytes_wanted: u32, buf: [bytes_wanted]u8) -> (string, SSL_Error) {
    bytes_read := -1
